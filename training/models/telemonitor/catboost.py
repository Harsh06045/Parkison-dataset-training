...
class TelemonitorCatBoostRegressor:
    """
    Multi-output CatBoost Regressor for UPDRS score prediction.
    """
    def __init__(self, iterations=100, depth=3, learning_rate=0.1, early_stopping_rounds=None):
        self.motor_model = cb.CatBoostRegressor(
